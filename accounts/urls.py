...
urlpatterns = [
    ...
    path("staff/login/waiting/<uuid:token>/", views.staff_login_waiting_view, name="staff_login_waiting"),
    path("staff/login/poll/<uuid:token>/", views.staff_login_poll, name="staff_login_poll"),
    path("staff/telegram/webhook/", views.telegram_login_webhook, name="telegram_login_webhook"),
